		...
		<div>
			<div className="session-wrapper" >
				<Grid container justify="center" alignItems="center">
					...
					<Grid item xs={12} sm={12} md={6} lg={8} style={{ backgroundImage: "url(" + require('assets/Images/session-forgot.jpg').default + ")", backgroundSize: 'cover', backgroundPosition: 'center left' }} className="img-session">
