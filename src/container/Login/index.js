			...
			<div>
				<div className="session-wrapper">
					<Grid container justify="center" alignItems="center">
						...
						<Grid item xs={12} sm={12} md={6} lg={8} style={{ backgroundImage: "url(" + require('assets/Images/session1bg.jpg').default + ")", backgroundSize: 'cover', backgroundPosition: 'center right' }} className="img-session">
