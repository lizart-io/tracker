		...
		<div>
			<div className="session-wrapper">
				<Grid container justify="center" alignItems="center">
					...
					<Grid item xs={12} sm={12} md={6} lg={8} className="img-session" style={{ backgroundImage: "url(" + require('assets/Images/session-signup.jpg').default + ")", backgroundSize: 'cover', backgroundPosition: 'center right' }}>
