				...
				<Box px={{ xs:'12px', lg:0 }}>
					<div className="page-space  payment-int-wrap">
						...
						<div className="payment-int-tab">
							...
							>
								<Tab style={{ backgroundImage: "url(" + require('assets/Images/stripe-sm.png').default + ")", backgroundSize: '85%', backgroundPosition: 'center center' }} className="payment-logo" {...a11yProps(0)} />
								<Tab style={{ backgroundImage: "url(" + require('assets/Images/paypal-sm.png').default + ")", backgroundSize: '82%	', backgroundPosition: 'center center' }} className="payment-logo" {...a11yProps(1)} />
							</Tabs>
