	...
	return (
		<div className="mod-profile-wrap">
			<Box py={3} className="mod-profile">
				<div className="mod-profile-header" style={{ backgroundImage: "url(" + require('assets/Images/blog-8.jpg').default + ")", backgroundSize: 'cover', backgroundPosition: 'center center' }}>
				</div>
				<Box className="mod-profile-detail">
					<Box>
						<div className="user-avatar">
							<img src={require('assets/Images/avatars/user-4.jpg').default} alt="user images" />
						</div>
						<Box>
