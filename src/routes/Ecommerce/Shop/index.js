															...
															<Grid item xs={12} sm={6} md={4} lg={4} key={index}>
																<Box className="product-list bg-white">
																	<Box className="relative" lineHeight={0.9} >
																		<img className="img-fluid" alt="img" src={require(`assets/Images/${product.image}`).default} />
																		<Fragment>
																...
																<Grid container alignItems="center">
																	<Grid item xs={12} sm={12} md={4} lg={3}>
																		<div className="img-holder">
																			<img className="img-fluid" alt="img" width="300" src={require(`assets/Images/${product.image}`).default}></img>
																		</div>
																	</Grid>
