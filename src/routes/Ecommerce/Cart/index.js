				...
				<Container maxWidth="lg">
					{cart.length > 0 ?
												...
												{!isCartEmpty() ? cart.map((cart, index) => (
													<div className="cart-list-item" key={index}>
														<Box className="cart-item-thumb" mb={{ xs:2, sm:0 }}>
															<img alt="cart-thumb" className="img-fluid" src={require(`assets/Images/${cart.image}`).default}></img>
														</Box>
						...
						<Box py={10} textAlign="center">
							<Box mb={2}>
								<img alt="cart-icon" src={require('assets/Images/cart-icon.png').default}/>
							</Box>
