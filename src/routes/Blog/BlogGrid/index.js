										...
										<Card className="blog-grid-item">
											<Box className={classes.thumbWrap}>
												<Link to={`/app/blog/blog-detail/${blog.id}`}>
													<img className="img-fluid" alt="img" height="250" src={require(`assets/Images/${blog.image}`).default} />
												</Link>
											...
											<Box>
												<CardContent>
													...
													<Box pt={2} display="flex" alignItems="center">
														<Box>
															<Avatar className={classes.avatar} alt="user-thumb" src={require(`assets/Images/avatars/${blog.authorImage}`).default} />
														</Box>
														<Box px={2}>
