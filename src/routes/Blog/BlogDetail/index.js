				...
				<div className="blog-detail-wrap">
					<Box pt={1}>
						<Paper className={classes.Paper}>
								...
								<Grid container spacing={3}>
									<Grid item xs={12} sm={12} md={7} lg={8}>
										...
										<Box display="flex" alignItems="center">
											<Box>
												<Avatar className={classes.authorImg} alt="user-thumb" src={require(`assets/Images/avatars/${selectedBlog.authorImage}`).default} />
											</Box>
							...
							<Box className={classes.backgroundProps} style={{ backgroundImage: 'url(' + require(`assets/Images/${selectedBlog.image}`).default + ')' }}>
							</Box>
												...
												<Grid item xs={12} sm={6} md={3}>
													<Card className={classes.card}>
														<Box lineHeight={0.9} style={{cursor:'pointer'}}>
															<img src={require(`assets/Images/${blog.image}`).default} alt="thumb-wrap" className={clsx(
