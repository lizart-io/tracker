								...
								<ul className="top-hits">
										...
										<div className="top-product">
											<div className="top-product-detail">
												<div className="top-product-thumb">
													<img alt="Remy Sharp" width={50} src={require(`assets/Images/accessroies/a-1-a.jpg`).default} />
												</div>
												<Box>
									...
									<li>
										<div className="top-product">
											<div className="top-product-detail">
												<div className="top-product-thumb">
													<img alt="Remy Sharp" width={50} src={require(`assets/Images/accessroies/a-2-a.jpg`).default} />
												</div>
												<Box>
									...
									<li>
										<div className="top-product">
											<div className="top-product-detail">
												<div className="top-product-thumb">
													<img alt="Remy Sharp" width={50} src={require(`assets/Images/accessroies/a-3-a.jpg`).default} />
												</div>
												<Box>
									...
									<li>
										<div className="top-product">
											<div className="top-product-detail">
												<div className="top-product-thumb">
													<img alt="Remy Sharp" width={50} src={require(`assets/Images/accessroies/a-4-a.jpg`).default} />
												</div>
												<Box>
									...
									<div className="user-card--queue">
										<ul>
											<li className="user-card--queue--thumb">
												<img alt="Remy Sharp" width={35} src={require(`assets/Images/avatars/user-1.jpg`).default} />
											</li>
											<li className="user-card--queue--thumb">
												<img alt="Remy Sharp" width={35} src={require(`assets/Images/avatars/user-2.jpg`).default} />
											</li>
										</ul>
									
									</div>
									<div className="user-card--thumb">
										<img alt="Remy Sharp" width={100} src={require(`assets/Images/avatars/user-6.jpg`).default} />
									</div>
